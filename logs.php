...
?>              
                ...
                <section class="complain_log_section">
                    ...
                    <?php
                            ...
                            from complain_log cl inner join complain c ON cl.c_id=c.id inner join user u on c.uid=u.uid inner join type_of_work tw on cl.level=tw.tow_id inner join status s on cl.status=s.ud";
